# AI IN THE MARKETING DECISION-MAKING: APPLIED  FRAMEWORK IN ORGANIZATIONAL CONTEXTS
The script was constructed by defining a detailed prompt template that instructs the model on how to categorize each abstract based on predefined criteria for Feeling AI, Mechanical AI, Thinking AI, Out of scope, Not identified levels. 
